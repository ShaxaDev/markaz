...
u2=types.InlineKeyboardButton('Зарегистрироваться',callback_data='ruxattt')
...
q2=types.InlineKeyboardButton('Ro`yxatdan o`tish',callback_data='ruyxat1')
...
o1=types.InlineKeyboardButton('STOP❌',callback_data='orqa')
o.add(o1)

jalab = types.ReplyKeyboardMarkup(row_width=1)
it = types.KeyboardButton('stop')
jalab.add(it)